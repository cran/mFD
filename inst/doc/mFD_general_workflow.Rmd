...
biomass, coverage, etc. This matrix must have assemblages names in rownames.
The studied example works with biomass (*i.e.* grams of
...
**NOTE** The traits types dataframe thus has: **two columns** if **no fuzzy traits and
...
(columns names:  `trait_name`,`trait_type` and `trait_weight`). See the first
part of the [Compute Functional Diversity Hill Indices](https://cmlmagneville.github.io/mFD/articles/Compute_functional_hill_indices.html) to see how the `fruits_traits` and `fruits_traits_cat` look like with 
fuzzy traits.
...
([Mouillot _et al._ 2014](https://www.pnas.org/doi/abs/10.1073/pnas.1317625111)).
...
instead) (**NB** If you only have continuous traits (see the 
[Continuous traits Framework](https://cmlmagneville.github.io/mFD/articles/Continuous_traits_framework.html): using up to the 1.0.6.9 version of the `mFD` package does not allow 
weighting, it will be done in a next version of the package. You can use the 
[`col.w`](https://rdrr.io/cran/FactoMineR/man/PCA.html) argument of the PCA
...
**NB** **If your data gather a high number of species and/or traits, this function
...
**NOTE** To know more and better understand how to interpret quality of functional
...
a triangle. Species of each assemblage have 
...
**NOTE** This function can compute two families of functional beta diversity indices,
...
**nestedness-resultant**. **NB** The **turnover** component is the highest if there
...
_Global Ecology and Biogeography_, **30**, 51-62.
...
_Trends in Ecology and Evolution_, **28**, 167-177.
