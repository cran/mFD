...
vignette: >
  %\VignetteIndexEntry{Customised plots}
...
assemblage and each element must be nammed after the assemblage **and the order in which each assemblage is given must reflect the same order than the asb_sp_coord_2D order**. Can be set up 
